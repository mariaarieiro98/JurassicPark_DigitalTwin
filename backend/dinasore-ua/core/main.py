...
if __name__ == "__main__":
    ...
    ################################################
    marketplace_bridge.MarketplaceBridge.initializeGenericRequester(mpHttpAddress,mpHttpPort,mpFtpAddress,address,port_opc,mpFtpPort)
    ################################################

    #########Create function block folder#####
    ################################################
    fb_resources.FBResources.generate_fb_folder()
    ################################################
