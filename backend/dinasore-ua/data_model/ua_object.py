...
class UaObject:
    ...
    def __init__(self, ua_peer, fb_name, fb_type, source_type, browse_name, root_folder):
        ...
        self.fb_state = self.ua_peer.create_variable(self.base_path, var_idx, browse_name, 1)
    ...
    def update_variables(self):
        ...
        # updates the value of the fb state
        self.fb_state.set_value(fb.actual_state)
