...
export const updateMonitoredVariable = (monitoredVariable: MonitoredVariable) : Promise<RequestResponseState> => fetchRequest(apiRoutes.getMonitoredVariablePath(RouteMethod.put,monitoredVariable.idMonitoredVariable),false,monitoredVariable)     
